	...
	public class Reinforcement
	{
		public Reinforcement()
		{
			...
			while (true)
			{
				...
				tcpCommClient.LoadModel(Janggi.TensorFlow.TcpCommClient.NetworkKinds.Policy, "pure_reign", "pure_reign");

				//대충 2550개정도로 모아볼까.
				while (recWin.Count < 255 * 10)
				{
					//게임 한 판 시작 ---------------------------
					//랜덤으로 보드 생성
					...
					Console.Write("collected count : " + recWin.Count);
				}
